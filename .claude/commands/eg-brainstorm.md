...
If **Save brief and stop**: write the concepts brief to `notes/eg-brainstorms/<slug>-<YYYY-MM-DD>.md` ONLY if the user confirms via one more `AskUserQuestion`:
...
- `multiSelect`: `false`
- `options`:
  1. **`notes/eg-brainstorms/<slug>-<YYYY-MM-DD>.md`** — "Save to notes/."
