...
PORTED from src/features/_utils.py (DraftEngineDesign.md §9.2).
Edits: v2 config API, scoring moves to domain, leakage guard reached
through platform.asof (§9.0, §11.3).
"""
